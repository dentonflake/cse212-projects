...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People are returned in reverse order instead of FIFO queue order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns are not re-enqueued as infinite-turn players.
    ...
    // Defect(s) Found: People with negative turns are not re-enqueued as infinite-turn players.
